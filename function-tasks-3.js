...
);
{
  ...
  function printMiddleLetter(str) {
    ...
    if(str.length % 2 === 1){
      ...
      console.warn("String doesn't have a middle letter")
    }
  }
  console.log("---");
...
);
{
  function isOnlyLetters(str) {
    // ... code
    if (/\d/.test(str) === false) return true;
    else {
      return false;
    }
  }
...
);
{
  function letterCount(str, searchLetter) {
    // code ...
    let searchLetterCount = 0;
    str.split("").forEach((char) => {
      if(char === searchLetter) searchLetterCount++
    })
    return searchLetterCount
  }
  console.log('---');
  console.log({
...
{
  function firstIndexOfLetterA(str) {
    // code ...
...
{
  function firstIndexOfLetter(str, searchLetter) {
    // code ...
    return str.indexOf(searchLetter)
  }
  console.log('---');
  console.log({
    'labas, a': firstIndexOfLetter('labas', 'a'),
    'kempės, k': firstIndexOfLetter('kempės', 'k'),
    '123123, z': firstIndexOfLetter('123123', 'z'),
  })
  console.log('---');
}
console.groupEnd();
...
);
{
  function indexesOfLetter(str, searchLetter) {
    // code ...
    let searchLetterIndexesArr = [];
    for (let i = 0; i < str.length; i++) {
      if(str[i] === searchLetter) searchLetterIndexesArr.push(i)
    }
    return searchLetterIndexesArr
  }
  console.log('---');
  console.log({
...
);
{
  function removeFirstLetterA(str) {
    ...
    if(str.split("").includes('a')){
      ...
      const firstString = str.split("").slice(0 , str.indexOf('a')).join("")
      const secondString = str.split("").slice(str.indexOf('a') + 1 , str.length ).join("")
      return firstString + secondString
    }else{
      return `String doesn't contain letter a`
    }
  }
  console.log('---');
  console.log({
...
);
{
  function removeLastLetterA(str) {
    ...
    if(str.split("").includes('a')){
      ...
      const firstString = str.split("").slice(0 , str.lastIndexOf('a')).join("")
      const secondString = str.split("").slice(str.lastIndexOf('a') + 1 , str.length ).join("")
      return firstString + secondString
    }else{
      return `String doesn't contain letter a`
    }
...
);
{
  function removeAllOccurencesOfLetterA(str) {
    ...
    for (let i = 0; i < splittedString.length; i++) {
      if(splittedString[i] === 'a') splittedString.splice(i,1)        
    }
...
);
{
  function removeAllOccurencesOfLetter(str, letter) {
    ...
    const splittedString = str.split("")
    for (let i = 0; i < splittedString.length; i++) {
      if(splittedString[i] === letter) splittedString.splice(i,1)        
    }
    return splittedString.join("")
  }
  console.log('---');
...
);
{
  function filterLetters(str, lettersToRemove) {
    const splittedString = str.split("")
    for (let i = 0; i < splittedString.length; i++) {
      if(lettersToRemove.includes(splittedString[i])  ) splittedString.splice(i,1)        
    }
    return splittedString.join("")
    // code ...
  }
